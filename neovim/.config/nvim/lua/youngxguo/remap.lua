...
end, { silent = true, desc = "Find files (open buffers and recent files first)" })
...
vim.keymap.set("n", "N", "Nzzzv")
vim.keymap.set("n", "<Esc>", "<cmd>fclose<CR><cmd>nohlsearch<CR>", { silent = true, desc = "Close float and clear search highlight" })
...
vim.keymap.set("n", "<leader>oo", function()
  actions.octo_with_progress("Octo pr", "Loading PR...", "octo")
end, { silent = true, desc = "Open PR for current branch" })
...
vim.keymap.set("n", "<leader>or", function()
  actions.octo_with_progress("Octo review", "Loading review...", "octo_panel")
